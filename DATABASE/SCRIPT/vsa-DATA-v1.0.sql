...
--
-- Host: localhost
-- Generation Time: Jan 14, 2019 at 10:09 PM
...
INSERT INTO `assign` (`cod_assign`, `cod_pet`, `cod_service`, `cod_state`, `date_assign`) VALUES
(1, 1, 1, 3, '2019-01-15 12:00:00');
...
--
ALTER TABLE `assign`
  MODIFY `cod_assign` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `state`
  MODIFY `cod_state` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
