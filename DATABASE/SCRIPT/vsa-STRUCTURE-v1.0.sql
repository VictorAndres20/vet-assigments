...
--
-- Host: localhost
-- Generation Time: Jan 11, 2019 at 01:15 PM
...
--
ALTER TABLE `assign`
  MODIFY `cod_assign` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `city`
--
ALTER TABLE `city`
  MODIFY `cod_city` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `service`
  MODIFY `cod_service` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `state`
--
ALTER TABLE `state`
  MODIFY `cod_state` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `t_service`
--
ALTER TABLE `t_service`
  MODIFY `cod_t_service` int(11) NOT NULL AUTO_INCREMENT;
--
